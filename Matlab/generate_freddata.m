% generate_freddata.m
% =========================================================================
% ***NOTE***: This file has been modified slightly from the original for
% interoperability with mainRecForecast.m - Aaron Smalter Hall, April 2017
% =========================================================================
% DESCRIPTION: 
...
first_month=month(dum.textdata(3,1))-1;
final_month=month(dum.textdata(end,1))-1;

% Year of final observation
first_year=year(dum.textdata(3,1));
...
dates = [first_year+first_month/12:1/12:final_year+final_month/12]';
